function[lat_r,lon_r,x0,y0,x1,y1] = wind_rotation_v2(u,v,stlat,stlon,lat,lon)
...
az = az-wd+180; % based on pixel rotation method, after rotation, all wind is from the north (north wind) --> i.e. point toward south is positive!
